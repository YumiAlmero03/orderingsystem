                ...
                {"data" : 'transaction',
                    ...
                    "render": function (data, type, row) {
                        ...
                        if ($title != 'Wait') {
                            ...
                            return '<form id="table-status" method="POST" action="/status-change">'+'@csrf'+'<input type="hidden" name="id" value="'+data.id+'"><a href=""><button type="submit" class="btn btn-primary">'+$title+'</button></a><input type="hidden" name="status" value="'+$next+'"></form>';
                        } else {
                            return $title;
                        }
...
xmlhttp.open("GET", "/request-list", true);
